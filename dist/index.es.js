import React, { createContext, PureComponent, useEffect } from 'react';
...
var Tabular = styled.div(_templateObject4(), function (props) {
  return props.style;
});
var TableWrapper = styled.table(_templateObject5());
...
function Table(props) {
  ...
  return React.createElement(DataStore, null, React.createElement(Paper, {
    ...
    renderIcon: renderIcon,
    rowsPerPageOptions: rowsPerPageOptions
  }))), data.length > 0 && React.createElement(TableFooter$2, {
