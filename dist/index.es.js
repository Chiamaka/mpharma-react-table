...
var TableWrapper = styled.table(_templateObject, function (props) {
  return props.style;
});
...
var FlexRow = styled.section(_templateObject$1);
...
var TableHeadRow = styled.tr(_templateObject4);

var TableHeader = styled.th(_templateObject5, text, function (props) {
  return props.align;
});
...
function TableBody(_ref) {
  ...
  return React.createElement(
    ...
    data.map(function (item, index) {
      return React.createElement(TableRow, { item: item, key: index, renderIcon: renderIcon, last: index === length });
    })
  );
}
